...
import { MenuIconId } from '@/types/menu';

// SVG icon components extracted from Sidebar.tsx
const iconMap: Record<MenuIconId, ReactNode> = {
  dashboard: (
...
export function MenuIcon({ icon, className = 'w-5 h-5' }: MenuIconProps) {
